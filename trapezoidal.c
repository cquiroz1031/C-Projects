...
/////////////////////////////////////////////////////////////////////////////////////////////////
/*  This program computes an integral numerically using the Trapezoidal Method.
 
    User Inputs:     a (lower boundary), b (upper boundary)
    Outputs:         integral (numerical value of integral), time (program runtime), accuracy 
    Compiler flags:  gcc -Wall trapezoidal.c -o trapezoidal -lm
...
// Define function that performs trapezoidal method integration
...
int main()
{
    ...
    for (n = 10; n <= 1010; n += 25)
    {
        ...
        integral = trap(a, b, n);  // Numerical integral value for each n

...
/////////////////////////////////////////////////////////////////////////////////////////////////
/*  This program computes an integral numerically using the Simpson 1/3 Method.
 
    User Inputs:     a (lower boundary), b (upper boundary)
    Outputs:         integral (numerical value of integral), time (program runtime), accuracy 
    Compiler flags:  gcc -Wall simpson13.c -o simpson13 -lm
...
// Define function that performs simpson 1/3 method integration
...
int main()
{
    ...
    integral = simp13(a, b, n);  // Numerical integral value for each n
